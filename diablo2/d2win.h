...
class d2_win {
 public:
  ...
  static void draw_boxed_text(wchar_t* str,
                              uint32_t x,
                              uint32_t y,
  ...
  static int32_t D2Win_10034_MixRGB(uint8_t nRed,
                                    uint8_t nGreen,
                                    uint8_t nBlue);

  static void set_popup_properties(
  ...
  static void* load_mpq(char* dllName,
                        char* mpqName,
                        char* mpqTitle,
