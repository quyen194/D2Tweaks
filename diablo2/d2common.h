...
class d2_common {
 public:
  ...
  static D2ItemStatCostTxt* get_item_stat_cost_record(int nStatId);
  ...
  // D2COMMON_DLL_DECL D2RunesTxt* __stdcall DATATBLS_GetRunesTxtRecord(
  //     int nRunewordId);
  static D2RunesTxt* get_runes_txt_record(int nRunewordId);
