...
enum D2C_AiSpecialState : uint32_t {
  ...
  // Set when classid > nMonStatsRecord
  AISPECIALSTATE_NO_MON_STATS = 1,
  ...
  // When whipped by overseer, for suicide minions
  AISPECIALSTATE_WHIPPED = 15,
  // When a unit is mounting another (tower / siege beast)
  AISPECIALSTATE_MOUNTING_UNIT = 16,
...
class d2_game {
 public:
  ...
  static D2MonPropTxt* __fastcall d2_game::MONSTER_GetMonPropTxtRecord(
      int32_t nId);
  ...
  static D2SkillsTxt* __fastcall d2_game::SKILLS_GetSkillsTxtRecord(
      int32_t nSkillId);

  // D2Game.0x6FD15580
  // int32_t __fastcall D2GAME_GetSummonIdFromSkill_6FD15580(
  //     D2UnitStrc* pUnit,
  ...
  //     int32_t* pX,
  //     int32_t* pY)
  static int32_t __fastcall d2_game::D2GAME_GetSummonIdFromSkill_6FD15580(
      Unit* pUnit,
      int32_t bFromMonster,
      int32_t nSkillId,
      int32_t nSkillLevel,
  ...
  // D2Game.0x6FD14430
  // D2UnitStrc* __fastcall D2GAME_SummonPet_6FD14430(
  //     D2GameStrc* pGame,
  ...
  // D2Game.0x6FD0C530
  // int32_t __fastcall D2GAME_SetSummonPassiveStats_6FD0C530(
  //     D2GameStrc* pGame,
  //     D2UnitStrc* pUnit,
  //     D2UnitStrc* pPet,
  //     int32_t nSkillId,
  ...
  // D2Game.0x6FD0C2E0
  // void __fastcall D2GAME_SetSummonResistance_6FD0C2E0(
  //     D2UnitStrc* pUnit, D2UnitStrc* pPet)
  static void __fastcall d2_game::D2GAME_SetSummonResistance_6FD0C2E0(
      Unit* pUnit, Unit* pPet);
  ...
  // D2Game.0x6FC69F10
  // D2UnitStrc* __fastcall D2GAME_SpawnMonster_6FC69F10(
  //     D2GameStrc* pGame,
