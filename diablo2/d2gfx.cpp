...
bool d2_gfx::check_perspective_coords(int32_t x, int32_t y) {
  static wrap_func_std_import<bool(int32_t, int32_t)> check_perspective_coords(
      10065, get_base());
...
int32_t d2_gfx::adjust_perspective_coords(int32_t x,
  ...
  static wrap_func_std_import<int32_t(
      ...
      adjust_perspective_coords(10066, get_base());
  return adjust_perspective_coords(x, y, 0, adjustX, adjustY);
}

int32_t d2_gfx::get_resolution_mode() {
  static wrap_func_std_import<int32_t()> get_resolution_mode(10005, get_base());
...
void d2_gfx::draw_filled_rect(
  ...
  static wrap_func_std_import<void(int, int, int, int, DWORD, int)>
      draw_boxed_text(10056, get_base());
