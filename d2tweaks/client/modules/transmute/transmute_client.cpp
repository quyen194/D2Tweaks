...
class auto_transmute_menu : public ui::menu {
 ...
 public:
  ...
  void draw() override {
    ...
    m_auto_transmute_btn->set_enabled(d2_client::get_ui_window_state(UI_WINDOW_INTERFACE));
    m_auto_transmute_btn->set_visible(d2_client::get_ui_window_state(UI_WINDOW_INTERFACE));
