...
void group::left_mouse(int32_t offsetX, int32_t offsetY, bool up, bool& block) {
  for (auto control : m_controls) {
...
void group::right_mouse(int32_t offsetX,
                        int32_t offsetY,
                        bool up,
                        bool& block) {
  for (auto control : m_controls) {
...
void group::key_event(int32_t offsetX, int32_t offsetY,
...
void group::add_control(control* control) {
