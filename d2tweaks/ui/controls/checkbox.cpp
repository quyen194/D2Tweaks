...
void checkbox::set_y(int32_t value) {
  m_rect.set_y(value);
  m_image->set_y(value);
  m_label->set_y(value);
  control::set_y(value);
...
void checkbox::left_mouse(int32_t offsetX,
                          int32_t offsetY,
                          bool up,
                          bool& block) {
...
void checkbox::right_mouse(int32_t offsetX,
                           int32_t offsetY,
                           bool up,
                           bool& block) {}

void checkbox::key_event(
