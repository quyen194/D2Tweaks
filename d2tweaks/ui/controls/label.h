...
class label : public control {
 ...
 public:
  ...
  const std::wstring& get_text() const { return m_text; }

  ui_color_t get_color() const { return m_color; }

  void set_color(const ui_color_t color) { m_color = color; }

  ui_font_t get_font() const { return m_font; }

  void set_font(const ui_font_t font) { m_font = font; }
