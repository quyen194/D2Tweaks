...
class asm_address {
 ...
 public:
  ...
  intptr_t get_full_offset() const { return m_full_offset; }
...
class asm_address_static final : public details::asm_address {
 ...
 public:
  ...
  intptr_t get_offset() const override { return m_offset; }

  intptr_t get() const override { return m_address; }
};
...
class asm_address_relative : public details::asm_address {
 ...
 public:
   ...
   * \param toAddress
   */
  asm_address_relative(intptr_t offset,
  ...
  void build(unsigned char* code) override {
    const auto fromAddress =
        reinterpret_cast<intptr_t>(code + get_full_offset());
    *reinterpret_cast<intptr_t*>(code + get_full_offset() + m_offset) =
...
class asm_code {
 ...
 public:
  ...
  size_t get_code_size() const { return m_offset; }
