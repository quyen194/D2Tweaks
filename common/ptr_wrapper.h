...
class wrap_func_cdecl_import_ {
 ...
 public:
  ...
  TRet operator()(Args... args) {
    if (!m_function_ptr) {
      m_function_ptr = reinterpret_cast<decltype(m_function_ptr)>(
          GetProcAddress(reinterpret_cast<HMODULE>(m_base),
...
class wrap_func_fast_import_ {
 ...
 public:
  ...
  TRet operator()(Args... args) {
    ...
    return reinterpret_cast<TRet(__fastcall*)(Args...)>(m_function_ptr)(
        args...);
  }
};
...
template <typename TRet, typename... Args>
class wrap_func_cdecl<TRet(Args...)>
    : public details::wrap_func_cdecl_<TRet, Args...> {
 public:
...
template <typename TRet, typename... Args>
class wrap_func_cdecl_import<TRet(Args...)>
    : public details::wrap_func_cdecl_import_<TRet, Args...> {
 public:
  wrap_func_cdecl_import(uint32_t ordinal, void* base)
      : wrap_func_cdecl_import_(ordinal, base) {};
};
...
template <typename TRet, typename... Args>
class wrap_func_std<TRet(Args...)>
    : public details::wrap_func_std_<TRet, Args...> {
 public:
...
template <typename TRet, typename... Args>
class wrap_func_std_import<TRet(Args...)>
    : public details::wrap_func_std_import_<TRet, Args...> {
 public:
  wrap_func_std_import(uint32_t ordinal, void* base)
      : wrap_func_std_import_(ordinal, base) {};
};
...
template <typename TRet, typename... Args>
class wrap_func_fast_import<TRet(Args...)>
    : public details::wrap_func_fast_import_<TRet, Args...> {
 public:
  wrap_func_fast_import(uint32_t ordinal, void* base)
      : wrap_func_fast_import_(ordinal, base) {};
};
...
template <typename TRet, typename... Args>
class wrap_func_fast<TRet(Args...)>
    : public details::wrap_func_fast_<TRet, Args...> {
 public:
